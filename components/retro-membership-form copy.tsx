      ...
      case 5:
        return (
          <div className="mt-6 text-green-400 text-sm">
            ...
            {/*
            <SquarePaymentForm amount={100} />
            <SquarePaymentForm amount={1000} />
            */}
        
            {/* <button
              onClick={() => {
                handlePackageSelect("Consultation Package")
                handleSquareRedirect(100, "Consultation Package")
              }}
            ...
            <div className="border border-green-400 rounded p-4 space-y-4 bg-black">
              <details className="group border border-green-500 rounded-md">
                <summary className="cursor-pointer px-4 py-2 bg-green-900 group-open:bg-green-700 font-bold">
                  Option A
                </summary>
